<?php 
	...
	class tintuc extends DController{
		...
		public function tatca(){
			//seo
			$this->load->title = 'Tất cả bài viết - mobileshop.com';
			$this->load->desc = 'Tất cả bài viết về thế giới di động  - mobileshop.com';
			$this->load->image = BASE_URL.'/public/images/logo2.jpeg';
