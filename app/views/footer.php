  <footer>
            ...
            <div class="bg_in">
               <div class="footer footer_bottom">
                  ...
                  <div class="footer-col">
                     ...
                     <div class="footer-col-content">
                        <ul class="social">
                           <li><a target="_blank"  href="https://www.facebook.com/thegioididongcom/" class="fb"><img src="<?php echo BASE_URL ?>/public/images/Fb.png">Facebook</a></li>
                           <li><a target="_blank" href="https://www.youtube.com/channel/UCWMzT0952OOpCMEBNX29Y5Q" class="fb"><img height="32" width="32" src="<?php echo BASE_URL ?>/public/images/youtube.png">Youtube</a></li>
                        </ul>
                        <div class="clear"></div>
                     </div>
                  </div>
                        ...
                        <ul class="icon_list">
                           <li>
                              <a href=".">
                                 ...
                                 <p class="text_li">
                                    <span class="phone_footer">Hotline: 035-990-8712 </span>
                                    <span class="text_small">(Từ 8h đến 20h tất cả các ngày)</span>
                                 </p>
                              </a>
                           </li>
                           <div class="clear"></div>
                           <li><a><i class="fa fa-envelope" aria-hidden="true"></i>  w3school.com</a></li>
                           <li><a><i class="fa fa-mouse-pointer" aria-hidden="true"></i>  http://web.com/</a></li>
                        </ul>
                     </div>
                  </div>
               </div>
            ...
            <div class="bg_in">
               <div class="footer">
                  <div class="infor_company">
                     <h3>CÔNG TY PHÂN PHỐI ĐIỆN THOẠI DI ĐỘNG  MOBILESHOP.COM</h3>
                     <a href=""><img src="<?php echo BASE_URL ?>/public/images/ct.png"  alt="ct.png" class="cangiua" /></a>
                  ...
                  <div class="footer-col">
                     ...
                     <div class="infor_footer">
                        <address>
                        <address>Địa Chỉ : 2/13, Lê Sát, Mỹ Bình, Long Xuyên, An Giang <br />
                           Điện thoại: 035-990-8712<br />
                           Email: duongminh318@mobileshop.com
                        </address>
                        </address>
                     </div>
                  </div>
                  <div class="footer-col">
                     ...
                     <div class="infor_footer">
                        <address>
                        <address>Địa Chỉ : Tháp Betexco, Hồ Tùng Mậu, Q1,TPHCM <br />
                           Điện thoại: 0923-032-992<br />
                           Email: duongminh318@moblieshop.com
                        </address>
                        </address>
                     </div>
                  </div>
         ...
         <div class="clear"></div>
         <div class="copyright">
            <h4 class="tkw9999">&copy;  © Bản quyền thuộc . Designed by <a href="http://w3school.com/" rel="dofollow" target="_blank">Thiet Ke Web</a> Bởi <a href="http://w3schools.com/">https://www.w3schools.com/</a></h4>
         </div>
      </footer>
      <div class="coccoc-alo-phone coccoc-alo-green coccoc-alo-show" id="coccoc-alo-phoneIcon" >
         <a href="tel:0359908712" title="Call me now">
